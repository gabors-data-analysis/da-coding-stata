...
cd "C:\bekeskezdi_stata\lec12_TSdata\"
...
*** a) Starting with the string case: -datestring- is a simple string variable here, it has nothing to do with dates...
...
* As you can see, we have now three new variables containing year, month, and day. Step 2: rename and destring them:
...
* ... for a more intuitive way of display, you should change the format (Step 4):
...
*** b) Let us now consider the original -date- variable that is recognized by Stata.
