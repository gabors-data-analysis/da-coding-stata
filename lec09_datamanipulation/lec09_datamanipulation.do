...
cd "da-coding-stata/lec09_datamanipulation/"
...
* Let us create a new variable containing the number of nonmissing values in varlist (again, with another wild card):
...
* Both 'generate' and 'egen' can be combined with the 'bysort' prefix using the logic we discussed in Lecture 6.
