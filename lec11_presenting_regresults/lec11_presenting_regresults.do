...
cd "C:\bekeskezdi_stata\lec11_presenting_regresults\"
...
* (Please note that we discuss graphs in Lecture 13, so now we only do some basics without any scaffolding.)

*** a) Plotting a simple regression
...
estout est1 est2 est3 est4, label

* For further formatting options, check the help menu:
help eststo

*** b) The 'outreg2' command
