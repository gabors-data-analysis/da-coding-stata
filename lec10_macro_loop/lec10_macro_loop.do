...
***************************************************** Lecture 10 ******************************************************
***********************************************************************************************************************
************************************** Macros, loops, branching, and stored results ***********************************
***********************************************************************************************************************
***********************************************************************************************************************

*************** The default folder
*** Defining the default folder
cd "da-coding-stata/lec10_macro_loop/"
...
*************** Topic 3: Branching
*** In some cases we need to do something if a condition is true, and something else, if the condition is not true...
*** ... In these cases, we should make branching, i.e. using an 'if' - 'else' condition.
*** Let us consider the following example: we create a new variable called -manag_number- that is equal to...
*** ... 2*-management- in waves 2004-2009, and 4*-management- in the waves after.

generate manag_number = .
forvalues i = 2004(1)2015 {
	if `i' < 2010 {
		local number 2
	}
	...
	replace manag_number = management*`number' if wave==`i'
}
	
 
*************** Topic 4: Stored results
